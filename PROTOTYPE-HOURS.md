# Prototype phase — hours log

**Phase: 13 – 27 September 2026**

Each member records the hours they actually worked. Add your hours in your own
column next to the activity you worked on, or add a new row if your activity is
not listed. Update the week total and the phase total when you do.

Please commit your own hours yourself, so the log matches the repository history.
